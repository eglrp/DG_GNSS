function XR_plot(XR1, XR2, XR3, pos, legends)
...
plot(1:n, XR2(1,:) - pos(1), 'color', [216/255 82/255 24/255])
...
plot(1:n, XR2(2,:) - pos(2), 'color', [216/255 82/255 24/255])
...
plot(1:n, XR2(3,:) - pos(3), 'color', [216/255 82/255 24/255])
...
plot(phi2, 'color', [216/255 82/255 24/255])
...
plot(lam2, 'color', [216/255 82/255 24/255])
...
plot(h2 - h_pos*ones(1,n), 'color', [216/255 82/255 24/255])
...
plot(1:n, XR_ENU2(1,:), 'color', [216/255 82/255 24/255])
...
plot(1:n, XR_ENU2(2,:), 'color', [216/255 82/255 24/255])
...
plot(1:n, XR_ENU2(3,:), 'color', [216/255 82/255 24/255])
